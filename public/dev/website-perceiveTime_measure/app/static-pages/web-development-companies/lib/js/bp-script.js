...
(function($) {
    "use strict";
		...
		$('[data-required="required"]').focus(function(){
		...
		$('#contact-form').each( function(){
		 ...
		 form.submit(function(e) {
		   ...
		   if (!e.isDefaultPrevented()) {
		   	...
		   	var helpWith = htmlDecode( $('textarea[name="helpWith"]').val() );
		   			helpWith = helpWith.replace(/"|'/g, '&quot;').replace(/\r?\n|\r/g, '');

		   	if( !$('.has_error').length ){
		   		var dataToSend = {
		   			"firstName" : $('input[name="firstName"]').val(),
		   			"lastName" : $('input[name="lastName"]').val(),
		   			"companyPosition" : $('input[name="companyPosition"]').val(),
		   			"companyName" : $('input[name="companyName"]').val(),
		   			"industry" : $('input[name="industry"]').val(),
		   			"teamSize" : $('input[name="teamSize"]').val(),
		   		...
		   		$.ajax({
						type: 'post',
						url: 'https://meet.toggl.com/business-inquiry',
