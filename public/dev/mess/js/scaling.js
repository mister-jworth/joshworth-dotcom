  ...
  update() {
    ...
    if (this.wealth >= transfer){
      ...
      for (let i = 0; i < society.citizens.length; i++){
          this.receiver.wealth -= tithe/(count);
          society.citizens[i].wealth += tithe/(count);
      } 
    } else {
    ...
    if (this.wealth >= transfer){
        for (let i = 0; i < society.citizens.length; i++){
            society.citizens[i].wealth += this.wealth*taxRate/(count);
        } 
        this.wealth -= this.wealth*taxRate;
      } else {
        this.wealth = this.wealth
      } 
