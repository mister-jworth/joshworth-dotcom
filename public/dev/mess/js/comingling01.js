...
class Citizen {
  ...
  update() {
   ...
   // WHAT'S UP HERE!
    ...
    // do normal effects, then do split effects only
    if(!checkSplitEffects.checked()){
      ...
      for (let i = 0; i < society.citizens.length; i++){ // adjust this loop to only apply to evens
        ...
        if (this.index % 2 == 0) { // even get the effects
